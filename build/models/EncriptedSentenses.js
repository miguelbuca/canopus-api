...
exports.Encriptedsentenses = void 0;
...
let Encriptedsentenses = (_dec = (0, _typeorm.Index)("encriptedsentenses_pkey", ["id"], {
  unique: true
}), _dec2 = (0, _typeorm.Entity)("encriptedsentenses", {
  schema: "public"
  ...
  nullable: true,
  default: () => "now()"
}), _dec7 = (0, _typeorm.Column)("timestamp with time zone", {
  name: "updated_at",
  nullable: true,
  default: () => "now()"
}), _dec(_class = _dec2(_class = (_class2 = class Encriptedsentenses {
  constructor() {
    _initializerDefineProperty(this, "id", _descriptor, this);

    _initializerDefineProperty(this, "name", _descriptor2, this);

    _initializerDefineProperty(this, "encriptedName", _descriptor3, this);
  ...
  writable: true,
  initializer: null
}), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "encriptedName", [_dec5], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
...
exports.Encriptedsentenses = Encriptedsentenses;